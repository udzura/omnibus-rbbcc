...
source url: "https://fossies.org/linux/misc/bzip2-#{version}.tar.gz"
...
build do
  ...
  command "cp -f libbz2.so* #{install_dir}/embedded/lib && chmod a+rx #{install_dir}/embedded/lib/libbz2.so*"
end
